...
export const getSandwich = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const CreateSandwich = async (req: any, res: Response, next: NextFunction) => {
    try {
...
export const UpdateSandwich = async (req: Request, res: Response, next: NextFunction) => {
    try {
